...
const BASE_URL = 'https://hip-molly-probably.ngrok-free.app';  // ←★★★ ここをあなたのngrok URLに変更（例: https://abc123.ngrok-free.app）
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('tts_premium handler error:', err);
